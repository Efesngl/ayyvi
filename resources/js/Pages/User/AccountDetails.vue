<template>
    <MainLayout>
        <div class="container-fluid h-auto">
            <div class="row" id="sections">
                <div class="col-12">
                    <ul class="nav nav-tabs justify-content-center">
                        <li class="nav-item">
                            <Link href="/hesabim/hesapdetaylari" :class="{ active: route().current() == 'profile.show' }" class="nav-link browse-link" active-class="active">
                                Hesap detayları
                            </Link>
                        </li>
                        <li class="nav-item">
                            <Link href="/hesabim/baslattigimkampanyalar" class="nav-link browse-link" active-class="active"> Başlattığım kampanyalar </Link>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container-fluid flex-column d-flex justify-content-center align-items-center pt-5 h-auto" id="user-page-content-container">
    ...
    <div
        ref="toast"
        class="toast align-items-center text-bg-success border-0 top-0 end-0 translate m-3 position-absolute"
        role="alert"
        aria-live="assertive"
        aria-atomic="true"
    >
